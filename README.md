# 🤖 Shepador AI — Autonomous Neural Agent-----canceled and redesigned due to huge codebase & issues!
...
|-----------|------|-------------|
|**Easy to configure and control**|Detailed web ui or CLI when no gui is present|✅ Your in control|
